...
public class BySelector {
    ...
    /**
     * Sets the search criteria to match elements that are indexed by index.
     *
     * @param index Whether to match elements that are indexed by index
     * @return A reference to this {@link BySelector}.
     */
    public BySelector index(int index) {
        if (mIndex != null) {
            throw new IllegalStateException("Index selector is already defined");
        }
        mIndex = index;
        return this;
    }
     ...
     * other criteria for this selector are met. If specified more than exec, matches must be found
     ...
     * criteria for this selector are met. If specified more than exec, matches must be found for
    ...
    public String toString() {
        ...
        if (mIndex != null) {
            builder.append("INDEX='").append(mIndex).append("', ");
        }
