...
public class By {
    ...
    /**
     * Constructs a new and empty {@link BySelector}.
     */
    public static BySelector newSelector() {
    ...
    /**
     * Constructs a new {@link BySelector} and sets the index.
     *
     * @see BySelector#index(int)
     */
    public static BySelector index(int index) {
        return new BySelector().index(index);
    }
