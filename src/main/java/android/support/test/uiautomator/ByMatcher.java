...
public class ByMatcher {
     ...
     */
    public static AccessibilityNodeInfo findMatch(UiDevice device, BySelector selector,
     ...
     */
    public static List<AccessibilityNodeInfo> findMatches(UiDevice device, BySelector selector,
                                                   AccessibilityNodeInfo... roots) {
    ...
    private List<AccessibilityNodeInfo> findMatches(AccessibilityNodeInfo root) {
        return findMatches(root, 0, 0, new SinglyLinkedList<>());
    }
    ...
    /** Helper method used to evaluate a {@link Integer} criteria if it is set. */
    static private boolean checkCriteria(Integer criteria, int index) {
        if (criteria == null) {
            return true;
        }
        return criteria.equals(index);
    }
    ...
    static private class PartialMatch {
        ...
        public static PartialMatch accept(AccessibilityNodeInfo node, BySelector selector,
            ...
            if (checkCriteria(selector.mClazz, node.getClassName()) &&
                    ...
                    checkCriteria(selector.mIndex, index)) {
